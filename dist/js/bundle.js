...
*/
var aa=__webpack_require__(6),n=__webpack_require__(5),ba=__webpack_require__(8);function ca(a,b,c,d,e,f,g,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var k=[c,d,e,f,g,h],l=0;a=Error(b.replace(/%s/g,function(){return k[l++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var response = this.state.data.map(function (item, index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Home2.default, { data: this.state.data }),
        response
      );
    }
  }]);
